...
namespace Digikala.DataAccessLayer.Migrations
{
    ...
    [Migration("20210703122145_ChangeTypeIconInCategory")]
    partial class ChangeTypeIconInCategory
    {
            ...
            modelBuilder.Entity("Digikala.DataAccessLayer.Entities.Identity.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConfirmEmail = true,
                            ConfirmMobile = true,
                            CreateDate = new DateTime(2021, 7, 3, 16, 51, 45, 98, DateTimeKind.Local).AddTicks(5930),
